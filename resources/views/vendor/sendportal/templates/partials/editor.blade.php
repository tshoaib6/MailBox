...
@push('js')
    ...
    <script>
        $(document).ready(function () {
            const codeMirror = CodeMirror.fromTextArea(document.getElementById('id-field-content'), {
                lineNumbers: true,
                lineWrapping: true,
                mode: 'xml',
                theme: 'monokai',
            ...
            window.sendportalTemplateEditor = codeMirror;

            $('.btn-preview').click(function (e) {
                e.preventDefault();

                const elContent = $('.template-preview');
                const elPreview = $('.template-content');
                const elButton = $('.btn-preview');
